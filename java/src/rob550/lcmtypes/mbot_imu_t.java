...
public final class mbot_imu_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(rob550.lcmtypes.mbot_imu_t.class))
            return 0L;
 
        classes.add(rob550.lcmtypes.mbot_imu_t.class);
    ...
    public static rob550.lcmtypes.mbot_imu_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        rob550.lcmtypes.mbot_imu_t o = new rob550.lcmtypes.mbot_imu_t();
    ...
    public rob550.lcmtypes.mbot_imu_t copy()
    {
        rob550.lcmtypes.mbot_imu_t outobj = new rob550.lcmtypes.mbot_imu_t();
