...
public final class pose_xyt_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(rob550.lcmtypes.pose_xyt_t.class))
            return 0L;
 
        classes.add(rob550.lcmtypes.pose_xyt_t.class);
    ...
    public static rob550.lcmtypes.pose_xyt_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        rob550.lcmtypes.pose_xyt_t o = new rob550.lcmtypes.pose_xyt_t();
    ...
    public rob550.lcmtypes.pose_xyt_t copy()
    {
        rob550.lcmtypes.pose_xyt_t outobj = new rob550.lcmtypes.pose_xyt_t();
