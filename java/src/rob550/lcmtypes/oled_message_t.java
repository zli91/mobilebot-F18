...
public final class oled_message_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(rob550.lcmtypes.oled_message_t.class))
            return 0L;
 
        classes.add(rob550.lcmtypes.oled_message_t.class);
    ...
    public static rob550.lcmtypes.oled_message_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        rob550.lcmtypes.oled_message_t o = new rob550.lcmtypes.oled_message_t();
    ...
    public rob550.lcmtypes.oled_message_t copy()
    {
        rob550.lcmtypes.oled_message_t outobj = new rob550.lcmtypes.oled_message_t();
